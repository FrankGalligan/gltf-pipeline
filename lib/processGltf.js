...
var compressDracoAnimations = require('./compressDracoAnimations');
...
function getStages(options) {
    ...
    if (defined(options.dracoAnimationOptions)) {
        stages.push(compressDracoAnimations);
    }
    return stages;
}
